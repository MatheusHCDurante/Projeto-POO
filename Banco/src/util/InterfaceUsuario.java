...
public abstract class InterfaceUsuario {
    ...
    static public void conferirValoresNegativosOuZero(int tipoFinanciamento) throws ValoresNegativosOuIgualZeroException {
    ...
    public int obterTipoDeFinanciamento() {
        while (true) { 
            ...
            Scanner scanner = new Scanner(System.in);
            try {
                // Oferece ao usário opções e solicita ao usuário o tamanho do terreno, e substitui o valor atraves do scanner.
                System.out.println("Escolha qual o tipo de ímovel que você deseja financiar:\n(1) Casa.\n(2) Apartamento.\n(3) Terreno.\n");
                tipoFinanciamento += scanner.nextInt();
                // Informa ao usuário o tipo de financiamento informado por ele.
